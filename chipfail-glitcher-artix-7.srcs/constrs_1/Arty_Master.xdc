...
set_property -dict { PACKAGE_PIN E1     IOSTANDARD LVCMOS33} [get_ports { rgb[0] }]; #led0_b
set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { rgb[1] }]; #led0_g IO_L19N_T3_VREF_35 Sch=led0_g
set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { rgb[2] }]; #led0_r IO_L19P_T3_35 Sch=led0_r
...
#set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS33} [get_ports {led_debug}]
#set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports {leds[1]}]
...
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports  { glitch_out }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { power_out }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2] closest to GND/POWER n.4
...
##Pmod Header JC
#
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { mux_out }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1] mux_enable
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { enable_c }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]  emable_c
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports  { glitch_out }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]     enable_b
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { power_out }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2] enable_a
...
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports uart_rxd_out]; # This is the TX output
...
#set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports {debug_header[0]}]
#set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {debug_header[1]}]
#set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {debug_header[2]}]
#set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {debug_header[3]}]
#set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports {debug_header[4]}]
#set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {debug_header[5]}]
#set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {debug_header[6]}]
#set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports {debug_header[7]}]
#set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {debug_header[8]}]
#set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVCMOS33} [get_ports {debug_header[9]}]
#set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {debug_header[10]}]
#set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {debug_header[11]}]
#set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {debug_header[12]}]
#set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports {debug_header[13]}]
...
set_property -dict {PACKAGE_PIN U11    IOSTANDARD LVCMOS33} [get_ports  { gpio[0]  }];
set_property -dict {PACKAGE_PIN V16    IOSTANDARD LVCMOS33} [get_ports   { gpio[1]  }];
set_property -dict {PACKAGE_PIN M13    IOSTANDARD LVCMOS33} [get_ports   { gpio[2]  }];
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports  { gpio[3]  }]; #IO_25_14 Sch=ck_io[29]
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports  { gpio[4]  }]; #IO_0_14 Sch=ck_io[30]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports  { gpio[5]  }]; #IO_L5N_T0_D07_14 Sch=ck_io[31]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports  { gpio[6]  }]; #IO_L13N_T2_MRCC_14 Sch=ck_io[32]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports  { gpio[7]  }]; #IO_L13P_T2_MRCC_14 Sch=ck_io[33]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports { trigger_in } ]; # Sch=ck_io[33]
#set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { ck_io[35] }]; #IO_L11N_T1_SRCC_14 Sch=ck_io[35]
#set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports vout_pwr]
