...
create_clock -period 83.330 -name sys_clk_pin -waveform {0.000 41.660} -add [get_ports sys_clk]
...
# Map GPIOs into an array so we can read them
...
# PIO46 is our trigger input
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { trigger_in }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]

# PIO47 is our power out
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { power_out }]; #IO_L14P_T2_SRCC_34 Sch=pio[47]
# PIO48 is our glitch out
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { glitch_out }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
